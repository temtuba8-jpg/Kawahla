...
def delete_user(user_id):
    ...
    # -----------------------------------------------------
    # التأكد أن الشخص آدمن
    # -----------------------------------------------------

    if not current_user.is_admin:

        flash(
            "غير مسموح لك بحذف المستخدمين.",
            "danger"
        )
    ...
    # -----------------------------------------------------
    # منع الآدمن من حذف حسابه الحالي
    # -----------------------------------------------------
    ...
    flash(
        "تم حذف المستخدم نهائياً وجميع بياناته المرتبطة بالمنتدى.",
        "danger"
    )
    ...
    try:
        ...
        for news in news_list:
            ...
            if news_id:
                ...
                # صفحة الأخبار الحالية تعتمد على /news
                # لذلك لا ننشئ رابطاً غير موجود.
                pass
