...
app.config["MONGO_URI"] = (
    "mongodb+srv://hzoooof11_db_user:YOUR_DB_PASSWORD@cluster0.outspyb.mongodb.net/kawahla_db?retryWrites=true&w=majority&appName=Cluster0"
)
...
class User(UserMixin):
  ...
  def __init__(self, user_data):
    if user_data:
      ...
      # إذا لم تكن هناك صورة، يتم وضع صورة افتراضية
...
def register():
  if request.method == "POST":
    ...
    new_user_data = {
        ...
        "lat": 15.5007,
        "lng": 32.5599,
        "profile_pic": profile_url,  # تخزين الرابط السحابي
        "document_pic": doc_url,  # تخزين الرابط السحابي
        "is_verified": False,
        "role": "user",
        "title_type": "عضو",
        "is_leader": False,
    ...
    flash(
        "تم التسجيل بنجاح! حسابك الآن قيد المراجعة والتحقق من انتمائك لقبيلة"
        " الكواهلة.",
        "info",
    )
